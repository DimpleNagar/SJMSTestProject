...
//		for (int i = 1; i <= 4; i++) {
//			WebElement eleToBeDrag = driver.findElement(By.xpath("//*[@id=\"todrag\"]/span[text()='Draggable " + i +"']"));
...
//		}
	...
	public void selectSubMenu() {
		...
		WebElement eleMainMenu = driver.findElement(By.xpath("//*[@id=\"navbar-brand-centered\"]/ul/li/a[contains(text(),'Input Forms')]"));
		
		eleMainMenu.click();
		
		Actions act = new Actions(driver);
	
		WebElement eleSubMenu = driver.findElement(By.xpath("//ul[@class='dropdown-menu']/li/a[contains(text(),'Checkbox Demo')]"));
